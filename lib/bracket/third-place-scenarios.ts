// Generated from FIFA World Cup 26 regulations Annex C (third-placed team scenarios).
// Columns map to the round-of-32 slots: 1A, 1B, 1D, 1E, 1G, 1I, 1K, 1L.
export const THIRD_PLACE_SCENARIO_SLOT_MATCH_NUMBERS = [79, 85, 81, 74, 82, 77, 87, 80] as const;

export const THIRD_PLACE_SCENARIOS: Record<string, readonly string[]> = {
