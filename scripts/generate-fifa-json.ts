...
const KNOCKOUT_RAW: {
  ...
  { fifa_match_number: 74, phase: "round_of_32", venueKey: "houston", home_source: { type: "group_rank", group: "C", rank: 1 }, away_source: { type: "group_rank", group: "F", rank: 2 } },
  { fifa_match_number: 75, phase: "round_of_32", venueKey: "boston", home_source: { type: "group_rank", group: "E", rank: 1 }, away_source: { type: "third_best", eligible_groups: ["A", "B", "C", "D", "F"] } },
  { fifa_match_number: 76, phase: "round_of_32", venueKey: "monterrey", home_source: { type: "group_rank", group: "F", rank: 1 }, away_source: { type: "group_rank", group: "C", rank: 2 } },
  { fifa_match_number: 77, phase: "round_of_32", venueKey: "dallas", home_source: { type: "group_rank", group: "E", rank: 2 }, away_source: { type: "group_rank", group: "I", rank: 2 } },
  { fifa_match_number: 78, phase: "round_of_32", venueKey: "new_york", home_source: { type: "group_rank", group: "I", rank: 1 }, away_source: { type: "third_best", eligible_groups: ["C", "D", "F", "G", "H"] } },
  ...
  { fifa_match_number: 81, phase: "round_of_32", venueKey: "seattle", home_source: { type: "group_rank", group: "G", rank: 1 }, away_source: { type: "third_best", eligible_groups: ["A", "E", "H", "I", "J"] } },
  { fifa_match_number: 82, phase: "round_of_32", venueKey: "santa_clara", home_source: { type: "group_rank", group: "D", rank: 1 }, away_source: { type: "third_best", eligible_groups: ["B", "E", "F", "I", "J"] } },
  { fifa_match_number: 83, phase: "round_of_32", venueKey: "los_angeles", home_source: { type: "group_rank", group: "H", rank: 1 }, away_source: { type: "group_rank", group: "J", rank: 2 } },
  { fifa_match_number: 84, phase: "round_of_32", venueKey: "toronto", home_source: { type: "group_rank", group: "K", rank: 2 }, away_source: { type: "group_rank", group: "L", rank: 2 } },
  ...
  { fifa_match_number: 86, phase: "round_of_32", venueKey: "dallas", home_source: { type: "group_rank", group: "D", rank: 2 }, away_source: { type: "group_rank", group: "G", rank: 2 } },
  { fifa_match_number: 87, phase: "round_of_32", venueKey: "miami", home_source: { type: "group_rank", group: "J", rank: 1 }, away_source: { type: "group_rank", group: "H", rank: 2 } },
  { fifa_match_number: 88, phase: "round_of_32", venueKey: "kansas_city", home_source: { type: "group_rank", group: "K", rank: 1 }, away_source: { type: "third_best", eligible_groups: ["D", "E", "I", "J", "L"] } },
