# Reglamento de La Mega Polla Mundialista 2026
...
| **Empate  + Marcador exacto**                              | **10 pts**     | **20 pts**           |
| **Empate  + Marcador distinto**                            | **5 pts**      | **10 pts**           |
...
En las fases de eliminación (octavos, cuartos, semifinales, tercer puesto y final) **sí es válido pronosticar empate** cuando el partido termina empatado después de los 90 minutos y se define en alargue o penales.

- El marcador que cuenta para los puntos es el resultado **después de 90 minutos** (90 reglamentarios).
- Si predices empate y aciertas el resultado después de 90 minutos (con marcador exacto o no), recibes **20 o 10 puntos** respectivamente.
- **Obligatorio**: Si pronosticas empate, **debes indicar qué equipo crees que avanzará** en el alargue o la tanda de penales .
...
- Predicción de **empate** (después de 90'): 20 pts (marcador exacto) o 10 pts (empate correcto).
- En ambos casos, el equipo que pronostiques que **avanza** suma **+2 puntos extras** si aciertas.

### Puntos Adicionales por Avance de Equipos

Al finalizar cada ronda real, recibirás **2 puntos extras** por cada equipo que tú pronosticaste correctamente que avanzaría a la siguiente fase.
...
- Solo se puede cambiar el marcador o el resultado del partido.
